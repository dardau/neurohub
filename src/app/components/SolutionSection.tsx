...
const roles = [
  {
    ...
    desc: 'Автоматические ИИ-отчёты по каждому ребёнку и дистанционное управление терапией: назначение, корректировка и контроль домашних модулей в один клик.',
  },
  {
    emoji: '👩‍👦',
    title: 'Кабинет Родителя',
    desc: 'Трекер прогресса, дневник развития и экстренная SOS-система с алгоритмами действий — прозрачность и поддержка без лишних звонков врачу.',
  },
  {
    emoji: '🧸',
    title: 'Phygital-среда Ребёнка',
    desc: 'Игры дают задания для взаимодействия с реальным миром: моторика, поиск предметов в комнате, диалог с родителем — а не «залипание» в экран.',
  },
];
