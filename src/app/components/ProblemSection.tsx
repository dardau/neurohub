...
const problems = [
  {
    title: 'Вакуум терапии',
    desc: '165 часов в неделю ребёнок без структурированной помощи — прогресс откатывается.',
    icon: (
  ...
  {
    title: 'Слепая зона для врача',
    desc: 'Оценка раз в месяц субъективна — нет объективной динамики между визитами.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Страх сделать «что-то не так» дома без понятных инструкций и поддержки.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Недоступность',
    desc: 'Очереди 3–6 месяцев и до 25 000 ₸ за сеанс — помощь недоступна большинству семей.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
